...
def parse_remma_interaction_data(interaction_file: str, pval_cutoff: float, chrom1: str, chrom2: str):
    ...
    with open(interaction_file) as csv_file:
        ...
        for line in csv_file:
            ...
            snp_2 = fields[3]    # SNP2
            p_value = float(fields[6])  # P-value
            ...
            for a in range(max_inter_length, 0, -1):
                for b in range(max_inter_length, 0, -1):
                    if i + a <= i_end and j + b <= j_end:
                        ...
                        if k > (m * n / N) and k > min_interactions-1:
...
if __name__ == '__main__':
    ...
    # bim_file = "test.bim"
    # interaction_file = "epistasis_test.epi.qt"
    # out_dir = ""
    # chrom1 = "1"
    # chrom2 = "2"
    # max_inter_length = 60
    ...
    chrom1 = sys.argv[1]
    chrom2 = sys.argv[2]
    bim_file = "ABCD_5099_qced.bim"
    interaction_file = f"../../ehlers/jiliu/epistasis_results/epistasis_results_chr{chrom1}_chr{chrom2}.epi.qt"
    out_dir = "trim_results_11/"
    max_inter_length = 60
    pval_cutoff = 1e-11
    ...
    if n == 0:
        ...
        pval_results = process_significant_interactions(significant_interactions, max_inter_length, N, n, upper_triangular)
